...
def raster_CSD_states(simulation, v_0, P, minV, maxV, resolution, state_hint_lower_right): # main bottleneck
    ...
    #print(f"Initial state found in {time.time() - start_time:.2f}s")
