...
class QDartsSimulator:
    """
    Configuration-driven QDarts simulator using Experiment class for tunneling/sensor.
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(description='QDarts v3 Experiment - Configuration-driven quantum device simulator using Experiment class')
